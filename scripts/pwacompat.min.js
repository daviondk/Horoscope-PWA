(function() {
    ...
    function B(a, b) {
        ...
        var x = g.map(function(a) {
                ...
                t("link", a);
                if (n) return a.rel = "apple-touch-icon", t("link", a)
            }),
            p = a.display;
        g = -1 !== C.indexOf(p);
        ...
        "fullscreen" === p ? (c("x5-fullscreen", "true"), c("full-screen", "yes")) : g && (c("x5-page-mode", "app"), c("browsermode", "application"));
        if (n) {
            var r = y(a.background_color || "#f8f9fa"),
                v = a.name || a.short_name || document.title;
            (p = G(a.related_applications)) && c("apple-itunes-app",
                "app-id=" + p);
            ...
            if (x.length) {
                ...
                q.onload = function() {
                    ...
                    if (a.background_color) {
                        var b = z(q, a.background_color);
                        null !== b && (l.href = b, x.slice(1).forEach(function(b) {
                            var d = new Image;
                            d.onload = function() {
    ...
    function G(a) {
        ...
        (a || []).filter(function(a) {
            ...
            a.id ? b = a.id : (a = a.url.match(/id(\d+)/)) &&
                (b = a[1])
        });
        return b
    }
    ...
    function D(a) {
        if (n || H) {
            var b = y(a);
            if (n) c("apple-mobile-web-app-status-bar-style", b ? "default" : "black");
            else {
                try {
                ...
                null === d ? console.debug("found Windows, could not fetch titleBar") : (d.foregroundColor = r(b ? "black" : "white"), d.backgroundColor = r(a))
            }
        }
    }
    ...
    if ("fetch" in window) {
        var C = ["standalone", "fullscreen", "minimal-ui"],
            n = navigator.vendor && -1 !== navigator.vendor.indexOf("Apple"),
